...
class ApiClient {
     ...
     */
    constructor(basePath = 'https://localhost:8017/shipmentTracking/v1') {
        /**
         * The base URL against which to resolve every API call's (relative) path.
         * @type {String}
         * @default https://localhost:8017/shipmentTracking/v1
         */
  ...
  /**
    ...
    */
    hostSettings() {
        return [
            {
              'url': "https://localhost:8017/shipmentTracking/v1",
